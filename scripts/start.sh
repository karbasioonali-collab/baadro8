...
# می‌آید تا سایت در دسترس بماند. خطای migrate/seed در لاگ کاملاً چاپ می‌شود.

echo "==> در حال اجرای prisma migrate deploy ..."
if ! npx prisma migrate deploy; then
  echo "!! prisma migrate deploy شکست خورد. سرور در ادامه بالا می‌آید، خطا را در لاگ سرویس بررسی کنید."
fi
